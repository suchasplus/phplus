<?php
class IndexController extends Plus_Controller
{
    ...
    {
        //$this->view = Plus_View::Standard(array('basePath' => 'views'));
        $id = $this->getVar('id');
        $this->view->id = $id;
    ...
    public function mongoAction()
    {
        ...
        $mongo = new Plus_Com_Mongo($config);
    ...
    public function pagerAction()
    {
        ...
        $page = new Plus_Com_Pager($p, 20, 268, '/demo/index.php/index/page/p/%page%/');
    ...
    {
        $data = Plus_Com_Http::get('http://www.google.com');

        var_dump(Plus_Com_Http::responseHeader());
    }
