...
class Plus_Config
{
    ...
    /**
     * Plus_Config provides a property based interface to
     * an array. The data are read-only unless $allowModifications
     * is set to true on construction.
     *
     * Plus_Config also implements Countable and Iterator to
    ...
    public function set($name, $value, $delimiter = '.')
    {
        ...
        if (!$this->_overwrite && isset($pos[$key])) {
            throw new Plus_Exception('this name of config is read only');
        } else {
            $pos[$key] = $value;
        }
    }
    ...
    public function __unset($name)
    {
        if ($this->_allowModifications) {
            ...
            throw new Plus_Exception('Plus_Config is read only');
        }
    }
     ...
     * after merge() has been used to merge multiple Plus_Config objects
