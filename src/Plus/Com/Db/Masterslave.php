...
class Plus_Com_Db_Masterslave extends Plus_Com_Db_Abstract
{
    /**
     * Configuration
     *
    ...
    public function master()
    {
        ...
        $this->_master = Plus_Com_Db::factory($config);
    ...
    public function slave($name = null)
    {
        ...
        $this->_slave = Plus_Com_Db::factory($config);
     ...
     *
     * @param string $msg
     * @return array|Plus_Com_Db_Abstract
     */
    ...
    public function __get($key)
    {
        switch ($key) {
            ...
            default:
                throw new Plus_Com_Db_Exception('Undefined property: ' . get_class($this). '::' . $key);
        }
    }
}
