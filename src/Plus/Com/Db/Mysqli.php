...
class Plus_Com_Db_Mysqli extends Plus_Com_Db_Abstract
{
    /**
     * Connect to database
     *
    ...
    protected function _connect($params)
    {
        if (!extension_loaded('mysqli')) {
            throw new Plus_Com_Db_Exception('NO_MYSQLI_EXTENSION_FOUND');
        }

        if ($params['persistent']) {
            throw new Plus_Com_Db_Exception('MYSQLI_EXTENSTION_DOES_NOT_SUPPORT_PERSISTENT_CONNECTION');
        }
        ...
        if (false === $connected) {
            throw new Plus_Com_Db_Exception($this->error());
        }
    ...
    public function query($sql)
    {
        ...
        throw new Plus_Com_Db_Exception($msg);
    }
