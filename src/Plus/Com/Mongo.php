...
Class Plus_Com_Mongo
{
    ...
    public function auth($user, $password)
    {
        ...
        throw new Plus_Exception('Mongo Auth Failed: bad user or password.');
    }
    ...
    public function autoIncrementId($domain, $collection = 'autoIncrementIds', $db = null)
    {
        ...
        throw new Plus_Exception('Plus_Com_Mongo: gen auto increment id failed');
    }
